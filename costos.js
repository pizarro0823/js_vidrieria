...
function limpiar()
{
document.getElementById("inpbase").value="";
...
function costos() {
  ...
  var porcentaje_de_ganacia = precio_cabezal + precio_sillar + precio_jamba + precio_enganche + precio_traslape + precio_socalos + precio_rodamientos + precio_guias + precio_empaque;

  var total_venta = costo_por_medidas + porcentaje_de_ganacia * 60 /100;
  ...
  x[1].innerHTML = "$ " + porcentaje_de_ganacia * 60 / 100 .toFixed(0);
